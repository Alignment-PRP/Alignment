            ...
            <div style={this.style.sidebar} onMouseEnter={this.open} onMouseLeave={this.close}>
                <MuiThemeProvider>
                    <Menu autoWidth={false} width={290}>
                        ...
                        <MenuItem primaryText="Krav"containerElement={<Link to="/requirements/all" />} rightIcon={<FontIcon style={this.style.rightIcon} className="material-icons">speaker_notes</FontIcon>}/>
