            ...
            <div style={this.style.sidebar} onMouseEnter={this.open} onMouseLeave={this.close}>
                <MuiThemeProvider>
                    <Menu autoWidth={false} width={290}>
                        ...
                        <MenuItem primaryText="ReduxTests"containerElement={<Link to="reduxtests" />} rightIcon={<FontIcon style={this.style.rightIcon} className="material-icons">build</FontIcon>}/>
